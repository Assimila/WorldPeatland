...
sources = [
        '/wp_data/sites/Degero/MODIS/MCD43A3.061/h18v02',
        '/wp_data/sites/kampar_1/MODIS/MCD43A3.061/h28v08',
        '/wp_data/sites/kampar_2/MODIS/MCD43A3.061/h28v08',
        '/wp_data/sites/kampar_3/MODIS/MCD43A3.061/h28v08',
        '/wp_data/sites/CongoNorth/MODIS/MCD43A3.061/h19v08',
        '/wp_data/sites/CongoSouth/MODIS/MCD43A3.061/h19v09',
        '/wp_data/sites/Norfolk/MODIS/MCD43A3.061/h18v03',
        '/wp_data/sites/MoorHouse/MODIS/MCD43A3.061/h17v03',
        '/wp_data/sites/HatfieldThorne/MODIS/MCD43A3.061/h17v03',
        '/wp_data/sites/Gnarrenburger/MODIS/MCD43A3.061/h18v03',
        '/wp_data/sites/MerBleue/MODIS/MCD43A3.061/h12v04']
...
for source_dir, output_dir in d.items(): 
    ...
    end_date = '30-06-2023'
    qa_def = 'BRDF_Albedo_Band_Mandatory_Quality_Band2'
    fname = "/workspace/WorldPeatland/QA_settings/MCD43A3.061_BRDF_Albedo_Band_Mandatory_Quality_Band2.json"
    # set the data variable to be masked 
    _data_var = '_Albedo_WSA_Band2'
