...
sources = [
        '/wp_data/sites/Degero/MODIS/MYD11A1.061/h18v02',
        '/wp_data/sites/kampar_1/MODIS/MYD11A1.061/h28v08',
        '/wp_data/sites/kampar_2/MODIS/MYD11A1.061/h28v08',
        '/wp_data/sites/kampar_3/MODIS/MYD11A1.061/h28v08',
        '/wp_data/sites/CongoNorth/MODIS/MYD11A1.061/h19v08',
        '/wp_data/sites/CongoSouth/MODIS/MYD11A1.061/h19v09',
        '/wp_data/sites/Norfolk/MODIS/MYD11A1.061/h18v03',
        '/wp_data/sites/MoorHouse/MODIS/MYD11A1.061/h17v03',
        '/wp_data/sites/HatfieldThorne/MODIS/MYD11A1.061/h17v03',
        '/wp_data/sites/Gnarrenburger/MODIS/MYD11A1.061/h18v03',
        '/wp_data/sites/MerBleue/MODIS/MYD11A1.061/h12v04']
...
for source_dir, output_dir in d.items(): 
    ...
    end_date = '30-06-2023'
    qa_def = 'QC_Night'
    fname = "/workspace/WorldPeatland/QA_settings/MYD11A1.061_QC_Night.json"
    # set the data variable to be masked 
    _data_var = '_LST_Night_1km'
