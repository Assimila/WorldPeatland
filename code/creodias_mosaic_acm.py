...
def create_daily_vrts(S3Paths, year, month, days, extent, product='S2_TOA'):
    ...
    for day in range(1, days + 1):
        ...
        for band in datasets:
            ...
            output_dir = os.path.join(OUTPUTDIR, 'datacube', product, band, 'VRTs')
...
url_start = (f"https://datahub.creodias.eu/odata/v1/Products?$filter="
             f"((Attributes/OData.CSC.DoubleAttribute/any(i0:i0/Name eq %27cloudCover%27 and i0/Value le "
             f"{cloud_cover_le})) and ")
